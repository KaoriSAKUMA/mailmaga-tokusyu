...
- **特集全体を指す件名にする（最重要）**：これは複数求人の特集メルマガなので、1つの求人だけを紹介する件名にしない
  - 個別求人のフックを使う場合は、「〜も」「〜など」＋全体件数を添えて、**特集内の一例だとわかる形**にする
  - NG：「月給27万7440円〜。船橋で道をつくる仕事です」（1求人のみを指し、全求人がこの給与だと誤解される）
  - OK：「月給27万の道づくりも。体を動かして働く10求人」
- **数字・条件は、全求人に共通しない限り言い切らない**：給与などを言い切ると特集全体の水準だと誤解される。全求人に共通する事実（例：全件未経験OK・転勤なし）は言い切ってよく、むしろ強いフックになる
...
##### 【数字インパクトパターン】（3本）
- 棚卸しした中で最も強い数字を**冒頭に**置き、特集全体の内容で着地させる
- 全求人に共通する数字・条件（全件◯◯）は言い切る。個別求人の数字は「〜も」＋件数で一例として使う
- 例：「10求人すべて未経験OK・月給25万円以上です」「年間休日125日の会社も。千葉の製造10求人」
...
- 個別求人の意外な事実を使う場合も、「〜も」「〜な仕事も」＋件数で特集の一例だとわかる形にする
- 釣りタイトルにはしない（本文で必ず回収できる事実ベース）
- 例：「『職場はダムのほとり』も。静かに働ける9求人」「倉庫なのに空調完備の会社も。千葉の10求人」

#### 4-4. セルフチェック（提示前に必ず実施）

9本それぞれについて以下を確認し、**1つでも×があれば作り直してから**提示する：

- [ ] **特集全体を指す件名か**（1つの求人の紹介文になっていないか）
- [ ] **数字・条件の誤解がないか**（全求人に当てはまらない数字を言い切っていないか。一例なら「〜も」等で明示されているか）
