...
- **特集全体を指す件名にする（最重要）**：これは複数求人の特集メルマガなので、**1つの求人にしか該当しない事実は件名に使わない**。「〜も」「〜など」で一例として添えるのも不可
  ...
  - OK：「10求人すべて未経験OK・転勤なしの正社員です」（全件に当てはまる事実）
...
##### 【数字インパクトパターン】（3本）
- 全求人に共通する数字・条件（全件◯◯、件数、エリアの広がり）を**冒頭に**置き、特集全体の内容で着地させる
- 例：「10求人すべて未経験OK・月給25万円以上です」「全9件が転勤なしの正社員。千葉で黙々と働く」

##### 【共感・自分ごとパターン】（3本）
- 読者のいまの状況・本音を一言で言い当て、その答えが特集の中にあることを見せる
- 「〜な方へ」「〜、ありませんか」「〜したい人向け」など語りかけ調
- 特集テーマ自体が「誰向けか」を言っているので、このパターンはテーマ全体と自然に噛み合う
- 例：「座りっぱなしが退屈な方へ。外で体を動かす10求人」「『家から近い』を最優先にした転職、アリです」

##### 【意外性・好奇心パターン】（3本）
- 「え、どういうこと？」と続きが気になる引きを、**特集全体の切り口**から作る
- 使える技法：職種を複数並べて共通点で引く（「鋼管、造園、酒蔵。共通点は〜」）、テーマの意外性を言い切る、集め方自体を見せる（「〜だけを集めたら9件ありました」）
- 個別求人にしか当てはまらない事実は使わない
- 釣りタイトルにはしない（本文で必ず回収できる事実ベース）
- 例：「鋼管、造園、酒蔵。共通点は『話さなくていい』」「『静かな職場』だけを集めたら、9求人ありました」
